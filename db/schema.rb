...
ActiveRecord::Schema.define(version: 20140209180003) do
  ...
  create_table "email_leads", force: true do |t|
    t.string   "email"
  ...
  create_table "unused_credits", force: true do |t|
    t.integer  "user_id"
    t.integer  "credits"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "users", force: true do |t|
    ...
    t.boolean  "superuser"
    t.boolean  "admin"
    t.integer  "monthly_credits",        default: 0
    t.integer  "account_id"
    t.integer  "adhoc_credits",          default: 0
    t.string   "first_name"
    t.string   "last_name"
  end
